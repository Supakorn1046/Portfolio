...
const translations = {
    th: {
        ...
        proj_1_desc: "ระบบจัดการเอกสารสำหรับการสร้างโครงการเพื่อขออนุมัติงบประมาณ รองรับการสร้างแบบฟอร์ม (Form Builder) สามารถติดตามสถานะเอกสารได้ทุกขั้นตอน (Tracking) และมีระบบจัดการสิทธิ์ผู้ใช้งาน (Permission Management)",
        proj_2_title: "Lanyard E-Commerce Platform for the USA Market",
        proj_2_desc: "เว็บไซต์อีคอมเมิร์ซสำหรับจำหน่ายสายคล้องคอและอุปกรณ์เสริมที่เกี่ยวข้อง สร้างขึ้นเพื่อขยายตลาดและรองรับกลุ่มลูกค้าในประเทศสหรัฐอเมริกาโดยเฉพาะ",
        proj_3_title: "Manga E-Commerce Platform",
        proj_3_desc: "แพลตฟอร์มอีคอมเมิร์ซสำหรับซื้อขายหนังสือการ์ตูนมังงะออนไลน์แบบครบวงจร มีฟีเจอร์ครอบคลุมตั้งแต่ระบบตะกร้าสินค้า การสั่งซื้อ ไปจนถึงระบบจัดการหลังบ้าน (Admin Dashboard) สำหรับจัดการข้อมูลผู้ใช้และสินค้า",
        proj_4_title: "2D Game Development Project",
        proj_4_desc: "พัฒนาเกม 2D แนวต่อสู้กับบอส (Boss Fight) ด้วย Unity โดยแบ่งการต่อสู้เป็น 2 เวฟ ประยุกต์ใช้ C# ในการพัฒนาระบบกลไกการต่อสู้ (Combat Mechanics) การจัดการแอนิเมชัน",
    ...
    en: {
        ...
        proj_1_title: "DMSKU Document Approval Workflow System",
        proj_1_desc: "A document management system for creating projects to request budget approvals. It features a Form Builder, comprehensive document status tracking, and a Permission Management system.",
        proj_2_title: "Lanyard E-Commerce Platform for the USA Market",
        proj_2_desc: "An e-commerce website for selling lanyards and related accessories, specifically built to expand the market and cater to customers in the United States.",
        proj_3_title: "Manga E-Commerce Platform",
        proj_3_desc: "A comprehensive e-commerce platform for buying and selling manga online. Features include a shopping cart, an intuitive checkout process, and an Admin Dashboard for managing user and product data.",
        proj_4_title: "2D Game Development Project",
        proj_4_desc: "Developed a 2D Boss Fight game using Unity with 2 battle waves. Applied C# to implement combat mechanics and animation management.",
        proj_5_title: "CompaxTech - Software Development Agency",
